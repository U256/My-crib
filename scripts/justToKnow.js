...
// HOISTING -поднятие. Инициализация для declared функций и var переменных ДО выполнения кода. var - undefined до момента объявления в коде, но она уже будет существовать!
varry; //undefined
var varry = 2;
...
//объект Global 
//Вызывается просто так или через '.' если часть логики
parseInt('3')
parseFloat()
isNaN()
isFinite()
